package AI.Queens;//Program to implement Hill Climbing with random restart to solve N-queens problem
...
public class HillClimbingRandomRestart {
    ...
    public static NQueen[] nextBoard(NQueen[] presentBoard) {
        ...
        // Then randomly generate new board and assign it to the best board
